;(function(win){
	var hadSettledList = {
      ...
      $tabs.on('click','.ptab',function(){
        ...
        util.storage.setItem('__pgetCashRecord', idx);
      ...
      var ptabIndx = util.storage.getItem('__pgetCashRecord') || 0;
      ...
      self.$load.show();
			$.ajax({
				url:root + '/rest/settlement/getWithdrawSalesPerformance',
		    type: 'GET', 
		    dataType: 'json',
		    contentType:'application/json;charset=UTF-8',
		    data:{
		    	supplierSettleAccountsId: self.id
		    },        
      ...
      self.$load.show();
			$.ajax({
				url:root + '/rest/settlement/getWithdrawOrderListInfo',
		    type: 'GET', 
		    dataType: 'json',
		    contentType:'application/json;charset=UTF-8', 
		    data:{
