;(function(win){
	var getCanNotWithdrawList = {
      ...
      $tabs.on('click','.ptab',function(){
        ...
        util.storage.setItem('__pnotGetCash', idx);
      ...
      var ptabIndx = util.storage.getItem('__pnotGetCash') || 0;
      ...
      self.$load.show();
			$.ajax({
				url:root + '/rest/settlement/getCanNotWithdrawSalesPerformance',
		    type: 'GET',
		    dataType: 'json',
      ...
      self.$load.show();
			$.ajax({
				url:root + '/rest/settlement/getCanNotWithdrawHotelInfo',
		    type: 'GET',
		    dataType: 'json',
		    contentType:'application/json;charset=UTF-8',
		    success: function(result) {
