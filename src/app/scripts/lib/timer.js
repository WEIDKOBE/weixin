			...
			*/
			...
			function showTimer(tempId){
					mode[tempId+"mode"] = "HH";
					var timerConent='<table cellpadding="0" cellspacing="0" style="border:#949495 1px solid;table-layout : fixed;width:100%" >'+
													'<tr style="width:85;height:20">'+
														'<td width="80" style="border:0px;display:block;padding:3px 0;"><input type="text"  maxlength="2" style="border:0;background:transparent;width:20" name="HH" value="00" onchange="checkNum('+"'"+tempId+"',"+"'HH',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','HH'"+')"/><input type="text"  style="border:0;background:transparent;width:10;" readOnly=true  value="/"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:20" name="MM" value="00" onchange="checkNum('+"'"+tempId+"',"+"'MM',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','MM'"+')"/><input type="text"  style="border:0;background:transparent;width:10"  readOnly=true value="/"/><input type="text"  maxlength="2" style="border:0;background:transparent;width:20" name="SS" value="00" onchange="checkNum('+"'"+tempId+"',"+"'SS',"+'this.value)" onkeydown="keyDown('+"'"+tempId+"'"+',event.keyCode,this)" onkeyup="keyUp(event.keyCode)" onfocus="setMode('+"'"+tempId+"','SS'"+')"/></td>'+
